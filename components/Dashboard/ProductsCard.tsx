...
const ProductsCard = ({product, selectedProduct, setSelectedProduct} : {product : Product, selectedProduct : string, setSelectedProduct : any}) => {
  return (
    <Card>
      <ImageWrapper href={'/'}>
        <Image src={product.imageUrl ? product.imageUrl[0] : 'https://agjoias.vercel.app/assets/icons/logo-og.jpg'} alt={product.title} fill className={'image'} sizes="(max-width: 384px)" />
      </ImageWrapper>
      <TextWrapper>
        <SpaceBetween>
